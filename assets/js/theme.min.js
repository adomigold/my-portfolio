    ...
    null != (r = document.querySelector(".navbar-sticky")) && (e = r.classList, t = r.offsetHeight, e.contains("navbar-floating") && e.contains("navbar-dark") ? window.addEventListener("scroll", function(e) { 500 < e.currentTarget.pageYOffset ? (r.classList.remove("navbar-dark"), r.classList.add("navbar-light", "navbar-stuck")) : (r.classList.remove("navbar-light", "navbar-stuck"), r.classList.add("navbar-dark")) }) : e.contains("navbar-floating") && e.contains("navbar-light") ? window.addEventListener("scroll", function(e) { 500 < e.currentTarget.pageYOffset ? r.classList.add("navbar-stuck") : r.classList.remove("navbar-stuck") }) : window.addEventListener("scroll", function(e) { 500 < e.currentTarget.pageYOffset ? (document.body.style.paddingTop = t + "px", r.classList.add("navbar-stuck")) : (document.body.style.paddingTop = "", r.classList.remove("navbar-stuck")) })),
        ...
        function() {
            for (var r = document.querySelectorAll(".password-toggle"), e = 0; e < r.length; e++) ! function(e) {
                ...
                r[e].querySelector(".password-toggle-btn").addEventListener("click", function(e) { "checkbox" === e.target.type && (e.target.checked ? t.type = "text" : t.type = "password") }, !1)
            }(e)
        }(),
        function() {
            for (var t = document.querySelectorAll(".file-drop-area"), e = 0; e < t.length; e++) ! function(e) {
                ...
                t[e].querySelector(".file-drop-btn").addEventListener("click", function() { a.click() }), a.addEventListener("change", function() {
                    var e;
        ...
        function() {
            ...
            if (null !== l) {
                for (var e = 0; e < l.length; e++) ! function(e) {
                    ...
                    l[e].addEventListener("submit", function(e) { e && e.preventDefault(), "" === n.value && s(this, t, a, r, o) })
                }(e);
        ...
        function() {
            ...
            if (0 !== e.length || 0 !== t.length || 0 !== l.length) {
                ...
                for (var a = 0; a < e.length; a++) {
                    ...
                    if (e[a].classList.add("line-chart-" + a), null != u) { n = JSON.parse(u); for (var f = 0; f < n.colors.length; f++) s = "\n          .line-chart-".concat(a, " .ct-series:nth-child(").concat(f + 1, ") .ct-line,\n          .line-chart-").concat(a, " .ct-series:nth-child(").concat(f + 1, ") .ct-point {\n            stroke: ").concat(n.colors[f], " !important;\n          }\n        "), c.appendChild(document.createTextNode(s)) }
                ...
                for (var b = 0; b < l.length; b++) ! function(e) {
                    ...
                    if (l[e].classList.add("cz-pie-chart-" + e), null != a) { t = JSON.parse(a); for (var n = 0; n < t.colors.length; n++) s = "\n        .cz-pie-chart-".concat(e, " .ct-series:nth-child(").concat(n + 1, ") .ct-slice-pie {\n            fill: ").concat(t.colors[n], " !important;\n          }\n        "), c.appendChild(document.createTextNode(s)) }
                    new Chartist.Pie(l[e], r, { labelInterpolationFnc: function(e) { return Math.round(e / r.series.reduce(o) * 100) + "%" } })
                }(b)
            }
        }(),
        function() {
        ...
        function() {
            ...
            if (0 !== e.length)
                for (var t = 0; t < e.length; t++) {
                    ...
                    var a = e[t].classList.contains("date-range") ? { plugins: [new rangePlugin({ input: e[t].dataset.linkedInput })] } : "{}",
        ...
        function() {
            ...
            if (null !== o)
                for (var e = 0; e < o.length; e++) ! function(e) {
                    function t() { if (a.checked) { r.parentNode.classList.add("price-switch-on"); for (var e = 0; e < n.length; e++) n[e].innerHTML = n[e].dataset.newPrice } else { r.parentNode.classList.remove("price-switch-on"); for (var t = 0; t < n.length; t++) n[t].innerHTML = n[t].dataset.currentPrice } }
                    var r = o[e].querySelector(".form-switch"),
                        a = r.querySelector('input[type="checkbox"]'),
                        n = o[e].querySelectorAll(".price");
                    t(), a.addEventListener("change", function() { t() })
                }(e)
        }(),
        function() {
        ...
        function() {
            for (var n = document.querySelectorAll(".range-slider"), e = 0; e < n.length; e++) ! function(e) {
                ...
                }), r.addEventListener("change", function() { t.noUiSlider.set([this.value, null]) }), a.addEventListener("change", function() { t.noUiSlider.set([null, this.value]) })
            }(e)
        }(),
        function() {
